...
class ExerciseurDémonPython(Exerciseur):
    ...
    def écrit_dockerfile(self):
        ...
        print("FROM pcap-registry.pcap-api.svc.cluster.local:5000/utils:python_alpine3.8", file=out)
        ...
        if self.avec_openfaas:
            ...
            print("EXPOSE 8082", file=out)
            print('CMD ["python3", "/exerciseur/' + self.nom_démon + '"]', file=out)
